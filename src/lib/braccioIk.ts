 ...
 * faulting.
 *
 * Coordinate convention matches the engine's Braccio rig: the arm sits
 * at the origin, base servo rotates about +Y. Targets are in the same
 * world frame; we add the plate height offset internally so callers can
 * pass raw world coordinates.
 */
