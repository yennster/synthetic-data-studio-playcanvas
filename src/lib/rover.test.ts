 ...
 * its kinematic collision spike; now that the live runtime uses the
 * physics engine's contact solver, the test keeps the distance check
 * inline. Returns true if the rover's chassis disc overlaps any
 * obstacle. */
