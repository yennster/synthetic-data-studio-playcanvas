 ...
 *   never stalls.
 *
 * Engine hook point: the PlayCanvas capture path renders offscreen,
 * reads the framebuffer into a PNG blob, then calls this function —
 * the pass never touches engine objects, only the encoded blob.
 */
